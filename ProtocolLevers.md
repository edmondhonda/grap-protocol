...
##### File: `RAMENTokenStorage.sol`
##### Description
address that controls the rebasing functionality. This contract is one of two contracts that can `mint`. It also tells how much to change `ramensScalingFactor`.
##### Setting
###### File: `RAMEN.sol`
...
##### File: `RAMENRebaser.sol`
##### Description
The peg the protocol should aim for relative to the reserveToken. i.e. `1e18` means 1:1 between the reserveToken and RAMEN.
##### init_value: `1e18`
##### Setting
###### File: `RAMENRebaser.sol`
```
...
##### File: `RAMENRebaser.sol`
##### Description
The amount of RAMEN that the rebaser mints that is sold to build the protocol's treasury. Decimals: 18. i.e. 1e17 == .1, or 10% of the rebase.
